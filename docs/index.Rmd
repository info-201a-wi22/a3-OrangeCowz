...
```{r trends over time plot, include = TRUE, echo = FALSE}
source("../source/analysis.R")
...
Then, with this in mind, I wanted to further analyze and expand my findings to all the races jail population data collected by the dataset. So, I created another trends over time plot with just that. 

```{r further analysis trends over time plot, include = TRUE, echo = FALSE}
source("../source/analysis.R")
...
Here, I could see that the increase with the white population in jail is vastly different than the increase in population for all black , latinx, native, and asian american & pacific islanders. 


## Variable Comparison Plot

```{r variable comparison plot, include = TRUE, echo = FALSE}
source("../source/analysis.R")
