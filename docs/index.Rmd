...
on includes all the prison population by race columns, the location such as state
...
The fourth relevent value of interest I'd like to calculate is the total population of prisoners jailed from the Immigration and Customs Enforcement  or ICE. I always hear about the injustice imprisonment of immagrants and other hispanic 'looking' citizens in Texas or Arizona, but I'd like to see if there are any in the state of Washington. Turns out, there are 53 prisoners that was jailed from ICE in Washington. 

The fifth and final relevent value of interest I'd like to calculate is the state with the least number of inmates. 
